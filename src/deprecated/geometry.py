...
def get_plain_and_transform(point1, point2, point3):
    ...
    return (p,
            lambda x: np.linalg.inv(np.column_stack((point2 - point1, point3 - point1, p.normal))).dot(x - point1),
            lambda x: np.column_stack((point2 - point1, point3 - point1, p.normal)).dot(x) + point1
            )
